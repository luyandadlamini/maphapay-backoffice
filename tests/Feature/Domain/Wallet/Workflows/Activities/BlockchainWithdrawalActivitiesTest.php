...
/**
 * Verifies that BlockchainWithdrawalActivities wraps tenant-scoped DB writes
 ...
 */
class BlockchainWithdrawalActivitiesTest extends TestCase
{
    ...
    {
        $traits = class_uses_recursive(BlockchainWithdrawalActivities::class);

        $this->assertArrayHasKey(
            WithTenantContext::class,
            $traits,
            'BlockchainWithdrawalActivities must use WithTenantContext so Temporal activity writes target the correct tenant DB.'
        );
    }

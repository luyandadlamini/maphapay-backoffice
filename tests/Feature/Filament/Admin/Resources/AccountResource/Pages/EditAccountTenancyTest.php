...
class EditAccountTenancyTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        if ($this->isInMemorySqlite()) {
            $this->markTestSkipped(
                'EditAccount tenancy tests require MySQL (SQLite :memory: cannot share tables across connections)'
            );
        }
    ...
    #[Test]
    public function editing_an_account_initializes_tenancy_for_that_accounts_tenant(): void
    {

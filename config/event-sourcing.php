...
return [
    ...
    'event_class_map' => [
        ...
        'minor_family_funding_link_created'       => App\Domain\Account\Events\MinorFamilyFundingLinkCreated::class,
        'minor_family_funding_link_expired'       => App\Domain\Account\Events\MinorFamilyFundingLinkExpired::class,
        'minor_family_funding_attempt_initiated'  => App\Domain\Account\Events\MinorFamilyFundingAttemptInitiated::class,
        'minor_family_funding_attempt_succeeded'  => App\Domain\Account\Events\MinorFamilyFundingAttemptSucceeded::class,
        'minor_family_funding_attempt_failed'     => App\Domain\Account\Events\MinorFamilyFundingAttemptFailed::class,
        'minor_family_funding_credited'           => App\Domain\Account\Events\MinorFamilyFundingCredited::class,
        'minor_family_support_transfer_initiated' => App\Domain\Account\Events\MinorFamilySupportTransferInitiated::class,
        'minor_family_support_transfer_succeeded' => App\Domain\Account\Events\MinorFamilySupportTransferSucceeded::class,
        'minor_family_support_transfer_failed'    => App\Domain\Account\Events\MinorFamilySupportTransferFailed::class,
        'minor_family_support_transfer_refunded'  => App\Domain\Account\Events\MinorFamilySupportTransferRefunded::class,
        // Minor account lifecycle events
        'minor_account_tier_advanced'                  => App\Domain\Account\Events\MinorAccountTierAdvanced::class,
        'minor_account_tier_advance_blocked'           => App\Domain\Account\Events\MinorAccountTierAdvanceBlocked::class,
        'minor_account_guardian_continuity_broken'     => App\Domain\Account\Events\MinorAccountGuardianContinuityBroken::class,
        'minor_account_guardian_continuity_restored'   => App\Domain\Account\Events\MinorAccountGuardianContinuityRestored::class,
        'minor_account_adult_transition_completed'     => App\Domain\Account\Events\MinorAccountAdultTransitionCompleted::class,
        'minor_account_adult_transition_frozen'        => App\Domain\Account\Events\MinorAccountAdultTransitionFrozen::class,
        'minor_account_lifecycle_exception_opened'     => App\Domain\Account\Events\MinorAccountLifecycleExceptionOpened::class,
        'minor_account_lifecycle_exception_resolved'   => App\Domain\Account\Events\MinorAccountLifecycleExceptionResolved::class,
        'minor_account_lifecycle_transition_scheduled' => App\Domain\Account\Events\MinorAccountLifecycleTransitionScheduled::class,
        'minor_account_lifecycle_transition_blocked'   => App\Domain\Account\Events\MinorAccountLifecycleTransitionBlocked::class,
        'minor_family_support_transfer_failed'         => App\Domain\Account\Events\MinorFamilySupportTransferFailed::class,
        'minor_family_support_transfer_refunded'       => App\Domain\Account\Events\MinorFamilySupportTransferRefunded::class,

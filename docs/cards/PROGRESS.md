...
| 0.4 | Delete any service that exists only to serve those endpoints | in_progress | 2026-05-08 | — | — | Verifying deleted controllers did not depend on a legacy-only service before marking complete. |

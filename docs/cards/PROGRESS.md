...
| 0.3 | Remove route registrations for `/api/virtual-card/*` in `routes/api.php` and `routes/api-compat.php` | in_progress | 2026-05-08 | — | — | Removing dead compatibility imports/routes from `routes/api-compat.php`; `routes/api.php` had no matches in task 0.1 inventory. |

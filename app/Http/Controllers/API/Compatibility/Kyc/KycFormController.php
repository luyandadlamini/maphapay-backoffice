...
class KycFormController extends Controller
{
    private const FIELD_DEFINITIONS = [
        ...
        'address_proof'   => ['name' => 'Proof of address', 'instruction' => 'Upload a clear photo or PDF of your utility bill or bank statement (within the last 3 months).'],
    ...
    private function buildReviewStep(): array
    {
        return [
            ...
            'step_number' => 6,
            'title'       => 'Review & Submit',
            'description' => 'Confirm and submit your verification for review',
            'fields'      => [
                [
                    'name'        => 'confirmation',
                    'label'       => 'I confirm that the information and documents I provided are accurate and complete.',
                    'type'        => 'checkbox',
                    'is_required' => true,
                ],
            ],

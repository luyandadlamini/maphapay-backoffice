...
@section('seo')
    @include('partials.seo', [
        ...
        'description' => config('brand.name', 'Zelta') . ' Platform - Open-source core banking infrastructure with 47 DDD domains, event sourcing, REST + GraphQL APIs, and cross-chain DeFi. MIT licensed.',
